...
with open('P0DTC2.txt') as handle:
    ...
    for record in records:
        ...
        a9 = "\nFunction:" + str(record.comments[1])
        a10 = "\nFunction:" + str(record.comments[2])
        a11 = "\nFunction:" + str(record.comments[3])
        ficheiro = open("SwissProt_S.txt",'w')
        ficheiro.write(a1)
        ficheiro.write(a2)
        ficheiro.write(a3)
        ficheiro.write(a4)
